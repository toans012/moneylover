  ...
  factory SignUpWithEmailAndPasswordFailure.code(String code){
    switch (code){
      ...
      case 'operation-not-allowed':
        return  SignUpWithEmailAndPasswordFailure('Operation is not allowed. Please contact suppor');
      case 'user-disabled':
        return  SignUpWithEmailAndPasswordFailure('This user has been disabled. Please contact suppor for help');
      default:
